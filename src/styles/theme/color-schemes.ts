...
interface ExtendedColorSystemOptions extends ColorSystemOptions {
  shadows?: Shadows;
}

const primarySchemes: Record<PrimaryColor, Record<'dark' | 'light', PaletteColorOptions>> = {
  chateauGreen: {
    dark: {
      ...chateauGreen,
...
export function colorSchemes(config: Config): Partial<Record<'dark' | 'light', ExtendedColorSystemOptions>> {
